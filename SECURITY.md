...
Report privately via GitHub's **[Report a vulnerability](https://github.com/dmfdeploy/dmf-infra/security/advisories/new)**
(Security → Advisories → Report a vulnerability) on the `dmf-infra` repository.
