# Contributing to dmf-infra

Generic Ansible playbooks and roles for the DMF Platform.
...
(The full pre-publish history lives in a LAN-only `dmf-infra-archive` Forgejo
...
- Keep roles generic — no env-specific values; placeholder syntax for all cluster
  identifiers.
